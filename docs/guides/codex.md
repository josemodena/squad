...
For an interactive Administrator session use `codex --model gpt-5.6-luna` and
...
Codex defaults are gpt-5.6-luna for Administrator, gpt-6-astra for Project Manager,
Architect and Architecture Reviewer, and gpt-5.6-sol for Engineer and Engineering
